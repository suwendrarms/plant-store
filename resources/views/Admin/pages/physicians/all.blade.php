        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-4 text-right">
                    <a href="{{ route('admin-dashboard-physician-deactivated') }}"
                        class="btn btn-sm btn-neutral float-right text-danger">
                        <i class="fa fa-plus-circle"></i>Disabled Physicians
                    </a>
                </div>
                            ...
                            <div class="dropdown no-arrow mb-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('admin-dashboard-physician-details', $user->id) }}"><i
                                    ...
                                    <a class="dropdown-item"
                                        href="{{route('admin-dashboard.simulate-physicians' , $user->id)}}"> <i
