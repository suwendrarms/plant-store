        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Insurance Provider</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-block ">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Start Here</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Insurance Provider</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a
                        ...
                        <i class=" fa fa-plus-circle"></i>New Insurance Provider
                    </a>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="settlements" class="table align-items-center table-flush" id="dataTable">
                            ...
                            <tbody>
                                @foreach ($insurance_provider as $provider)
                                        ...
                                        <div class="dropdown no-arrow mb-4">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin-edit-insurance-provider',$provider->id) }}"><i
                                                        class="fas fa-user-edit text-warning"></i>&nbsp;Edit</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-user" data-id="{{ $provider->id }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('save-insurance-provider') }}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="name">Enter Insurance Provider</label>
...
<script>
    ...
    $(".delete-user").on('click', function () {
        ...
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    window.location.href = '{{ url("admin/delete-insurance-provider") }}/' + id;
                },
                cancel: function () {
