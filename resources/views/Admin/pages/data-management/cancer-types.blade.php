        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Cancer Types</h6>
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a
                        ...
                        <i class=" fa fa-plus-circle"></i>New Cancer Type
                    </a>
                </div>
            </div>
            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="table-responsive">
                        <table  id="settlements" class="table align-items-center table-flush" id="dataTable3" >
                                        ...
                                        <div class="dropdown no-arrow mb-4">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin-edit-cancer-type',$cancer_type->id) }}"><i
                                                        class="fas fa-user-edit text-warning"></i>&nbsp;Edit</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-user" data-id="{{ $cancer_type->id }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Cancer Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('save-cancer-type') }}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="name">Enter Cancer Type</label>
...
<script>
    ...
    $(".delete-user").on('click', function () {
        ...
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    window.location.href = '{{ url("admin/delete-cancer-type") }}/' + id;
                },
                cancel: function () {
