        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">New Medical Condition</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-block ">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Start Here</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Medical Condition</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a
                        ...
                        <i class=" fa fa-plus-circle"></i>New Medical Condition
                    </a>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="settlements" class="table align-items-center table-flush" id="dataTable">
                            ...
                            <tbody>
                                @foreach ($medical_conditions as $medication)
                                        ...
                                        <div class="dropdown no-arrow mb-4">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin-edit-medical-conditions',$medication->id) }}"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Medical Condition</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('save-medical-conditions') }}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="name">Enter Medical Condition</label>
...
<script>
    ...
    $(".delete-user").on('click', function () {
        ...
        $.confirm({
            title: 'Are you sure?',
            content: 'This will permenantly delete this medical condition',
            buttons: {
                confirm: function () {
                    window.location.href = '{{ url("admin/delete-medical-conditions") }}/' + id;
                },
                cancel: function () {
