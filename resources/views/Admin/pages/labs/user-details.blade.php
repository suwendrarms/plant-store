...
<div class="header pb-6 d-flex align-items-center" style="min-height: 200px;
     background-image: url('@if ($user->image){{ asset('uploads/crop/'.$user->image->name) }}@else{{ asset('img/lab-default.png')  }}@endif');
...
<div class="row">
    <div class="col-xl-3 order-xl-1">
                ...
                <div class="col-lg-3 order-lg-2">
                    <div class="card-profile-image">
                        <a href="#">
                            ...
                            <img src="{{ asset('img/lab-default.png')  }}" alt="Progile Image" class="rounded-circle">
                            @endif
                        </a>
                    </div>
                </div>
        ...
        <div class="col-xl-8 order-xl-1 center px-0">
