        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-4 text-right">
                    <a href="{{ route('admin-dashboard-users-deactivated') }}"
                        class="btn btn-sm btn-neutral float-right text-danger">
                        <i class="fa fa-plus-circle"></i>Disabled Patients
                    </a>
                </div>
                <div class=" text-right">
                    <a href="{{route('admin-dashboard-new-user')}}"
                        class="btn btn-sm btn-neutral float-right  pl-4 pr-4">
            ...
            <table id="settlements" class="table align-items-center table-flush" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach ( $user->getPatientReferrer($user->parent_id) as $ref )
                            {{ $ref->user_name }}<br>
                            <span class="badge badge-success">{{ $ref->email }}</span>
                            @endforeach
                        </td>
                        <td>
                            c.soon
                        ...
                        <td>
                            <div class="dropdown no-arrow mb-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item"
                                        href="{{route('admin-dashboard.simulate-user' , $user->id)}}"> <i
