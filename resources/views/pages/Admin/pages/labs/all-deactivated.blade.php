        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
               ...
               <div class="col-lg-4 text-right">
                    <a href="{{ route('admin-dashboard-lab') }}"
                        class="btn btn-sm btn-neutral float-right text-success">
                        <i class="fa fa-plus-circle"></i>Active Laboratory
                    </a>
                </div>
                <div class=" text-right">
                    <a href="{{route('admin-dashboard-new-laboratory')}}"
                            ...
                            <div class="dropdown no-arrow mb-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('admin-dashboard-laboratory-details-deactivated', $user->id) }}"><i
