        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Laboratory</h6>
                ...
                <div class="col-lg-4 text-right">
                    <a href="{{ route('admin-dashboard-lab-deactivated') }}"
                        class="btn btn-sm btn-neutral float-right text-danger">
                        <i class="fa fa-plus-circle"></i>Disabled Laboratories
                    </a>
                </div>
                <div class="text-right">
                    <a href="{{ route('admin-dashboard-new-laboratory') }}" class="btn btn-sm btn-neutral pl-2 pr-3">
                            ...
                            <div class="dropdown no-arrow mb-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('admin-dashboard-laboratory-details', $user->id) }}"><i
                                            class="fas fa-eye text-primary"></i>&nbsp;View</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item delete-user" data-id="{{ $user->id }}"
                                        href="javascript:void(0)">
                                        <i class="fas fa-user-times text-danger"></i>&nbsp;Delete</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                        href="{{route('admin-dashboard.simulate-labs' , $user->id)}}"> <i
                                            class="fas fa-users text-blue"> </i>&nbsp;Simulate User</a>
                                </div>
                            </div>
                        </td>
                    </tr>
...
<script>
    ...
    $(".delete-user").on('click', function () {
        ...
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    window.location.href = '{{ url("admin/delete-laboratory") }}/' + id;
                },
                cancel: function () {
