        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Insurance Type</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-block ">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Start Here</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Insurance Type</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a
                        ...
                        <i class=" fa fa-plus-circle"></i>New Insurance Type
                    </a>
                </div>
            </div>
...
{{-- <div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between pl-1  mt-3">
        <h1 class="h3 mb-0 text-gray-800">Insurance Types</h1>
        <a href="" class="btn btn-primary mb-4 float-right" data-toggle="modal" data-target="#addModal"><i class=" fa
            fa-plus-circle"></i>New Insurance Type</a>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Admin Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Insurance Types</li>
        </ol>
    </nav>
    <div class="row justify-content-center">
        <div class="col-md-12"> --}}
                                        ...
                                        <div class="dropdown no-arrow mb-4">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin-edit-insurance-type',$type->id) }}"><i
                                                        class="fas fa-user-edit text-warning"></i>&nbsp;Edit</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-user" data-id="{{ $type->id }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('save-insurance-type') }}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="name">Enter Insurance Type</label>
...
<script>
    ...
    $(".delete-user").on('click', function () {
        ...
        $.confirm({
            title: 'Are you sure?',
            content: 'This will permenantly delete this insurance-type',
            buttons: {
                confirm: function () {
                    window.location.href = '{{ url("admin/delete-insurance-type") }}/' + id;
                },
                cancel: function () {
